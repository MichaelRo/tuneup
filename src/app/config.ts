...
export type AppRoute = (typeof STEP_ROUTES)[number]['hash'] | typeof ROUTE_DEFAULT | '#/settings';

export const ALL_ROUTES: AppRoute[] = [ROUTE_DEFAULT, ...STEP_ROUTES.map(route => route.hash), '#/settings'];
